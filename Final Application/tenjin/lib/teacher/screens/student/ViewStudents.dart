              ...
              onPressed: (){
                return showDialog(
                    ...
                    builder: (BuildContext context){
                      return AlertDialog(
                        title: Text('View Students'),
                        content: const Text('This Screen is responsible for viewing students for by course. Select the people icon to view students in desired course.', style: TextStyle(fontSize: 20),),
                      );
                    }
                );
              }
