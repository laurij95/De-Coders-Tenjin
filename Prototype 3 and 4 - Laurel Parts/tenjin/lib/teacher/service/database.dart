...
class DatabaseService{
  ...
  final CollectionReference fileUploadsCollection = Firestore.instance.collection('file_uploads');
  ...
  Future uploadFileData(String fileUrl, String fileName) async{
    await print(new DateTime.now().millisecondsSinceEpoch);
    //await fileUploadsCollection.document(uid).collection(collectionPath).document(fileName).setData({'name' : fileName, 'file': fileUrl});
  }
