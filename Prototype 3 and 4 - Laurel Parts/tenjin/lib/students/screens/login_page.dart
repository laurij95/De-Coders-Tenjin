...
class _LoginPageState extends State<LoginPage>
{
 ...
 Future<List>_login() async{
   final response = await http.post("http://192.168.1.10/tenjindb/login.php",
     body:{
        "username":user.text,
         "password":pass.text,
          "LastName":LastName,
       ...
       if(datauser[0]['level']=='member')
         {
           ...
           Navigator.push(
               context,
               MaterialPageRoute(builder: (context) => Member_page(FirstName: FirstName,LastName: LastName,Email: Email)));
